world_items = {
    ...
    # "danger": boolean (if true, go to game over state. In game over state, check what item or room danger boolean = true, and display that specific game over message. (specific messages probably in another dictionary))
    ...
    "piles of paper": "The papers are shredded. The pages of fanfiction won’t here won’t help you here.",
    ...
    "chekhov's gun": {
        ...
        "prereq": "hazard suit",
        "death_msg": "Wading through the pools of water, you begin to realize that the radiation is too much for your feeble body can handle. GAME OVER."
    },

    ### WOODEN FURNITURE ## HAS METAL BULLET QUESTION
    "wooden furniture": {
...
world_rooms = {
    ...
    # "key_item": string/None (key of item that must be visited in order to enter this Room, or None if no Item is required),
    ...
    ### THE STUDY ## Only has locked description
    "study": {
        "title" : "The Study",
        "room_desc" : 
            #Locked Description
